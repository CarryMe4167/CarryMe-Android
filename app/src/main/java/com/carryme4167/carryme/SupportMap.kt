...
class SupportMap : AppCompatActivity(), OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener,
...
//            startActivity(back)
            ...
            resultIntent.putExtra("locdatalat", lat)
            resultIntent.putExtra("locdatalong", long)
        ...
        task.addOnFailureListener { e ->
            if (e is ResolvableApiException) {
                ...
                try {
                    ...
                    e.startResolutionForResult(this@SupportMap,
